...
# TA-COMMENT: (-0.5) Technically, you've created a tuple, not a list. Remember, lists have [ ]!
...
print('The second to last element of the list is', countries[numberocountries - 2]) # TA-COMMENT: Just -2 will work.
...
# TA-COMMENT: FYI, you could've put age in as an integer so that you won't have to cast it as an int later on (this happens automatically if you don't put quotes around the number in your dictionary).
